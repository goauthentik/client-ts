...
export function SAMLSourceToJSONTyped(value?: Omit<SAMLSource, 'pk'|'component'|'verbose_name'|'verbose_name_plural'|'meta_model_name'|'managed'|'icon_url'|'icon_themed_urls'|'url_issuer'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
