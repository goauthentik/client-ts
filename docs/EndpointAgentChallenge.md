...
```typescript
import type { EndpointAgentChallenge } from '@goauthentik/api'
...
} satisfies EndpointAgentChallenge
...
const exampleParsed = JSON.parse(exampleJSON) as EndpointAgentChallenge
