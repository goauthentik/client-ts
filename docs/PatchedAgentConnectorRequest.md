...
```typescript
import type { PatchedAgentConnectorRequest } from '@goauthentik/api'
...
} satisfies PatchedAgentConnectorRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedAgentConnectorRequest
