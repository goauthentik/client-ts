...
import {
    SamlVersionEnumFromJSON,
    SamlVersionEnumFromJSONTyped,
    SamlVersionEnumToJSON,
    SamlVersionEnumToJSONTyped,
} from './SamlVersionEnum';
...
export function WSFederationProviderFromJSONTyped(json: any, ignoreDiscriminator: boolean): WSFederationProvider {
    ...
    return {
        ...
        'samlVersion': json['saml_version'] == null ? undefined : SamlVersionEnumFromJSON(json['saml_version']),
...
export function WSFederationProviderToJSONTyped(value?: Omit<WSFederationProvider, 'pk'|'component'|'assigned_application_slug'|'assigned_application_name'|'assigned_backchannel_application_slug'|'assigned_backchannel_application_name'|'verbose_name'|'verbose_name_plural'|'meta_model_name'|'url_download_metadata'|'url_wsfed'|'url_issuer'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
