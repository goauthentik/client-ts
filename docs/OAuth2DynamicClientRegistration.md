...
```typescript
import type { OAuth2DynamicClientRegistration } from '@goauthentik/api'
...
} satisfies OAuth2DynamicClientRegistration
...
const exampleParsed = JSON.parse(exampleJSON) as OAuth2DynamicClientRegistration
