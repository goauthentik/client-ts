...
import type { SourcesAllSetIconCreateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // boolean (optional)
    clear: true,
  } satisfies SourcesAllSetIconCreateRequest;

  try {
    const data = await api.sourcesAllSetIconCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { SourcesAllSetIconUrlCreateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // FilePathRequest
    filePathRequest: ...,
  } satisfies SourcesAllSetIconUrlCreateRequest;

  try {
    const data = await api.sourcesAllSetIconUrlCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
async function example() {
  ...
  const body = {
    ...
    // 'identifier' | 'name_deny' | 'name_link' | How the source determines if an existing group should be used or a new group created.   (optional)
    groupMatchingMode: groupMatchingMode_example,
    ...
    // string (optional)
    slug: slug_example,
    // 'email_deny' | 'email_link' | 'identifier' | 'username_deny' | 'username_link' | How the source determines if an existing user should be authenticated or a new user enrolled.   (optional)
    userMatchingMode: userMatchingMode_example,
...
| **groupMatchingMode** | `identifier`, `name_deny`, `name_link` | How the source determines if an existing group should be used or a new group created.   | [Optional] [Defaults to `undefined`] [Enum: identifier, name_deny, name_link] |
...
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
| **slug** | `string` |  | [Optional] [Defaults to `undefined`] |
| **userMatchingMode** | `email_deny`, `email_link`, `identifier`, `username_deny`, `username_link` | How the source determines if an existing user should be authenticated or a new user enrolled.   | [Optional] [Defaults to `undefined`] [Enum: email_deny, email_link, identifier, username_deny, username_link] |
...
async function example() {
  ...
  const body = {
    ...
    // string (optional)
    authenticationFlow: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // 'POST' | 'POST_AUTO' | 'REDIRECT' (optional)
    bindingType: bindingType_example,
    ...
    // string (optional)
    name: name_example,
    // 'urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName' | 'urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress' | 'urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified' | 'urn:oasis:names:tc:SAML:2.0:nameid-format:WindowsDomainQualifiedName' | 'urn:oasis:names:tc:SAML:2.0:nameid-format:persistent' | 'urn:oasis:names:tc:SAML:2.0:nameid-format:transient' | NameID Policy sent to the IdP. Can be unset, in which case no Policy is sent.   (optional)
    nameIdPolicy: nameIdPolicy_example,
    // string | Which field to use when ordering the results. (optional)
    ordering: ordering_example,
    // number | A page number within the paginated result set. (optional)
    page: 56,
...
| **authenticationFlow** | `string` |  | [Optional] [Defaults to `undefined`] |
| **bindingType** | `POST`, `POST_AUTO`, `REDIRECT` |  | [Optional] [Defaults to `undefined`] [Enum: POST, POST_AUTO, REDIRECT] |
...
| **managed** | `string` |  | [Optional] [Defaults to `undefined`] |
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
| **nameIdPolicy** | `urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName`, `urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress`, `urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified`, `urn:oasis:names:tc:SAML:2.0:nameid-format:WindowsDomainQualifiedName`, `urn:oasis:names:tc:SAML:2.0:nameid-format:persistent`, `urn:oasis:names:tc:SAML:2.0:nameid-format:transient` | NameID Policy sent to the IdP. Can be unset, in which case no Policy is sent.   | [Optional] [Defaults to `undefined`] [Enum: urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName, urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress, urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified, urn:oasis:names:tc:SAML:2.0:nameid-format:WindowsDomainQualifiedName, urn:oasis:names:tc:SAML:2.0:nameid-format:persistent, urn:oasis:names:tc:SAML:2.0:nameid-format:transient] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
| **pbmUuid** | `string` |  | [Optional] [Defaults to `undefined`] |
