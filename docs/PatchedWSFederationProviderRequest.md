...
```typescript
import type { PatchedWSFederationProviderRequest } from '@goauthentik/api'
...
} satisfies PatchedWSFederationProviderRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedWSFederationProviderRequest
