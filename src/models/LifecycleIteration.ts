...
export function LifecycleIterationToJSONTyped(value?: Omit<LifecycleIteration, 'id'|'object_id'|'object_verbose'|'object_admin_url'|'state'|'opened_on'|'grace_period_end'|'next_review_date'|'reviews'|'rule'|'user_can_review'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
