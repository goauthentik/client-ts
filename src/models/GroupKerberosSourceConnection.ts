...
export function GroupKerberosSourceConnectionToJSONTyped(value?: Omit<GroupKerberosSourceConnection, 'pk'|'group'|'source_obj'|'created'|'last_updated'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
