...
import {
    GrantTypesEnumFromJSON,
    GrantTypesEnumFromJSONTyped,
    GrantTypesEnumToJSON,
    GrantTypesEnumToJSONTyped,
} from './GrantTypesEnum';
...
export function OAuth2ProviderRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): OAuth2ProviderRequest {
    ...
    return {
        ...
        'grantTypes': json['grant_types'] == null ? undefined : ((json['grant_types'] as Array<any>).map(GrantTypesEnumFromJSON)),
...
export function OAuth2ProviderRequestToJSONTyped(value?: OAuth2ProviderRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'grant_types': value['grantTypes'] == null ? undefined : ((value['grantTypes'] as Array<any>).map(GrantTypesEnumToJSON)),
