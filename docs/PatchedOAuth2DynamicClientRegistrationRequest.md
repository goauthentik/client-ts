...
```typescript
import type { PatchedOAuth2DynamicClientRegistrationRequest } from '@goauthentik/api'
...
} satisfies PatchedOAuth2DynamicClientRegistrationRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedOAuth2DynamicClientRegistrationRequest
