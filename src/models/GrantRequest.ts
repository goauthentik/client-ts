...
export function GrantRequestToJSONTyped(value?: Omit<GrantRequest, 'created'|'created_by'|'revoked_by'|'is_active'|'status'|'targets'|'target_objs'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
