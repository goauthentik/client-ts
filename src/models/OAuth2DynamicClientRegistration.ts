...
export function OAuth2DynamicClientRegistrationFromJSONTyped(json: any, ignoreDiscriminator: boolean): OAuth2DynamicClientRegistration {
    ...
    return {
        ...
        'overrideAuthorizationFlow': json['override_authorization_flow'] == null ? undefined : json['override_authorization_flow'],
        'overrideInvalidationFlow': json['override_invalidation_flow'] == null ? undefined : json['override_invalidation_flow'],
...
export function OAuth2DynamicClientRegistrationToJSONTyped(value?: Omit<OAuth2DynamicClientRegistration, 'pbm_uuid'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
