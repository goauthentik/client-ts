...
```typescript
import type { MutualTLSStageRequest } from '@goauthentik/api'
...
const example = {
  ...
  "certAttribute": null,
  "userAttribute": null,
} satisfies MutualTLSStageRequest
...
const exampleParsed = JSON.parse(exampleJSON) as MutualTLSStageRequest
