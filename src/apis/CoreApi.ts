...
export class CoreApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for coreApplicationsSetIconCreate without sending the request
     */
    async coreApplicationsSetIconCreateRequestOpts(requestParameters: CoreApplicationsSetIconCreateRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['slug'] == null) {
            throw new runtime.RequiredError(
                'slug',
    ...
    async coreApplicationsSetIconCreateRaw(requestParameters: CoreApplicationsSetIconCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.coreApplicationsSetIconCreateRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for coreApplicationsSetIconUrlCreate without sending the request
     */
    async coreApplicationsSetIconUrlCreateRequestOpts(requestParameters: CoreApplicationsSetIconUrlCreateRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['slug'] == null) {
            throw new runtime.RequiredError(
                'slug',
    ...
    async coreApplicationsSetIconUrlCreateRaw(requestParameters: CoreApplicationsSetIconUrlCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.coreApplicationsSetIconUrlCreateRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
