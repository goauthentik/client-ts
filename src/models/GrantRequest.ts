...
export function instanceOfGrantRequest(value: object): value is GrantRequest {
    ...
    if (!('agentOwner' in value) || value['agentOwner'] === undefined) return false;
...
export function GrantRequestToJSONTyped(value?: Omit<GrantRequest, 'created'|'created_by'|'revoked_by'|'agent_owner'|'is_active'|'status'|'targets'|'target_objs'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
