...
```typescript
import type { PatchedKerberosSourceRequest } from '@goauthentik/api'
...
} satisfies PatchedKerberosSourceRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedKerberosSourceRequest
