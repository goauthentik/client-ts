...
```typescript
import type { PatchedGoogleWorkspaceProviderRequest } from '@goauthentik/api'
...
const example = {
  ...
  "dryRun": null,
} satisfies PatchedGoogleWorkspaceProviderRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedGoogleWorkspaceProviderRequest
