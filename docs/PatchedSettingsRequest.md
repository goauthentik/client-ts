...
```typescript
import type { PatchedSettingsRequest } from '@goauthentik/api'
...
const example = {
  ...
  "flags": null,
} satisfies PatchedSettingsRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedSettingsRequest
