...
export function GroupLDAPSourceConnectionToJSONTyped(value?: Omit<GroupLDAPSourceConnection, 'pk'|'source_obj'|'created'|'last_updated'|'group_obj'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
