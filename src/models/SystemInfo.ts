...
export function SystemInfoToJSONTyped(value?: Omit<SystemInfo, 'http_headers'|'http_host'|'http_is_secure'|'brand'|'server_time'|'embedded_outpost_disabled'|'embedded_outpost_host'|'base_url'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
