...
export function UserOffboardingToJSONTyped(value?: Omit<UserOffboarding, 'id'|'user_obj'|'status'|'created_by_obj'|'created_at'|'executed_at'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
