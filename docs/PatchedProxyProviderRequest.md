...
```typescript
import type { PatchedProxyProviderRequest } from '@goauthentik/api'
...
} satisfies PatchedProxyProviderRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedProxyProviderRequest
