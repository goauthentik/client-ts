...
export function PolicyBindingToJSONTyped(value?: Omit<PolicyBinding, 'pk'|'policy_obj'|'group_obj'|'user_obj'|'expires'|'expiring'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
