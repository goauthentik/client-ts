...
```typescript
import type { PatchedPasswordPolicyRequest } from '@goauthentik/api'
...
} satisfies PatchedPasswordPolicyRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedPasswordPolicyRequest
