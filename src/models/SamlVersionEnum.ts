...
export function SamlVersionEnumFromJSONTyped(json: any, ignoreDiscriminator: boolean): SamlVersionEnum {
...
export function SamlVersionEnumToJSONTyped(value: any, ignoreDiscriminator: boolean): SamlVersionEnum {
