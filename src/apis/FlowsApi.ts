...
export class FlowsApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for flowsInstancesSetBackgroundCreate without sending the request
     */
    async flowsInstancesSetBackgroundCreateRequestOpts(requestParameters: FlowsInstancesSetBackgroundCreateRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['slug'] == null) {
            throw new runtime.RequiredError(
                'slug',
    ...
    async flowsInstancesSetBackgroundCreateRaw(requestParameters: FlowsInstancesSetBackgroundCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.flowsInstancesSetBackgroundCreateRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for flowsInstancesSetBackgroundUrlCreate without sending the request
     */
    async flowsInstancesSetBackgroundUrlCreateRequestOpts(requestParameters: FlowsInstancesSetBackgroundUrlCreateRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['slug'] == null) {
            throw new runtime.RequiredError(
                'slug',
    ...
    async flowsInstancesSetBackgroundUrlCreateRaw(requestParameters: FlowsInstancesSetBackgroundUrlCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.flowsInstancesSetBackgroundUrlCreateRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
