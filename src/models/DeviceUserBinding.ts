...
export function DeviceUserBindingToJSONTyped(value?: Omit<DeviceUserBinding, 'pk'|'policy_obj'|'group_obj'|'user_obj'|'expires'|'expiring'|'connector'|'connector_obj'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
