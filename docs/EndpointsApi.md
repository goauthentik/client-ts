...
> AppleIndependentSecureEnclave endpointsAgentsPssoIseCreate(appleIndependentSecureEnclaveRequest)
...
import type { EndpointsAgentsPssoIseCreateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    appleIndependentSecureEnclaveRequest: ...,
  } satisfies EndpointsAgentsPssoIseCreateRequest;

  try {
    const data = await api.endpointsAgentsPssoIseCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> endpointsAgentsPssoIseDestroy(uuid)
...
import type { EndpointsAgentsPssoIseDestroyRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Apple Independent Secure Enclave.
    uuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies EndpointsAgentsPssoIseDestroyRequest;

  try {
    const data = await api.endpointsAgentsPssoIseDestroy(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **uuid** | `string` | A UUID string identifying this Apple Independent Secure Enclave. | [Defaults to `undefined`] |
...
> PaginatedAppleIndependentSecureEnclaveList endpointsAgentsPssoIseList(appleEnclaveKeyId, ordering, page, pageSize, search, user)
...
import type { EndpointsAgentsPssoIseListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string (optional)
    appleEnclaveKeyId: appleEnclaveKeyId_example,
    // string | Which field to use when ordering the results. (optional)
    ordering: ordering_example,
    // number | A page number within the paginated result set. (optional)
    page: 56,
    ...
    // number (optional)
    user: 56,
  } satisfies EndpointsAgentsPssoIseListRequest;

  try {
    const data = await api.endpointsAgentsPssoIseList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **appleEnclaveKeyId** | `string` |  | [Optional] [Defaults to `undefined`] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
...
> AppleIndependentSecureEnclave endpointsAgentsPssoIsePartialUpdate(uuid, patchedAppleIndependentSecureEnclaveRequest)
...
import type { EndpointsAgentsPssoIsePartialUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Apple Independent Secure Enclave.
    uuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // PatchedAppleIndependentSecureEnclaveRequest (optional)
    patchedAppleIndependentSecureEnclaveRequest: ...,
  } satisfies EndpointsAgentsPssoIsePartialUpdateRequest;

  try {
    const data = await api.endpointsAgentsPssoIsePartialUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **uuid** | `string` | A UUID string identifying this Apple Independent Secure Enclave. | [Defaults to `undefined`] |
| **patchedAppleIndependentSecureEnclaveRequest** | [PatchedAppleIndependentSecureEnclaveRequest](PatchedAppleIndependentSecureEnclaveRequest.md) |  | [Optional] |
...
> AppleIndependentSecureEnclave endpointsAgentsPssoIseRetrieve(uuid)
...
import type { EndpointsAgentsPssoIseRetrieveRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Apple Independent Secure Enclave.
    uuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies EndpointsAgentsPssoIseRetrieveRequest;

  try {
    const data = await api.endpointsAgentsPssoIseRetrieve(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> AppleIndependentSecureEnclave endpointsAgentsPssoIseUpdate(uuid, appleIndependentSecureEnclaveRequest)
...
import type { EndpointsAgentsPssoIseUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // AppleIndependentSecureEnclaveRequest
    appleIndependentSecureEnclaveRequest: ...,
  } satisfies EndpointsAgentsPssoIseUpdateRequest;

  try {
    const data = await api.endpointsAgentsPssoIseUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> Array&lt;UsedBy&gt; endpointsAgentsPssoIseUsedByList(uuid)
...
import type { EndpointsAgentsPssoIseUsedByListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Apple Independent Secure Enclave.
    uuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies EndpointsAgentsPssoIseUsedByListRequest;

  try {
    const data = await api.endpointsAgentsPssoIseUsedByList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> GoogleChromeConnector endpointsGoogleChromeConnectorsCreate(googleChromeConnectorRequest)
...
import type { EndpointsGoogleChromeConnectorsCreateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    googleChromeConnectorRequest: ...,
  } satisfies EndpointsGoogleChromeConnectorsCreateRequest;

  try {
    const data = await api.endpointsGoogleChromeConnectorsCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> endpointsGoogleChromeConnectorsDestroy(connectorUuid)
...
import type { EndpointsGoogleChromeConnectorsDestroyRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Google Device Trust Connector.
    connectorUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies EndpointsGoogleChromeConnectorsDestroyRequest;

  try {
    const data = await api.endpointsGoogleChromeConnectorsDestroy(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **connectorUuid** | `string` | A UUID string identifying this Google Device Trust Connector. | [Defaults to `undefined`] |
...
> PaginatedGoogleChromeConnectorList endpointsGoogleChromeConnectorsList(name, ordering, page, pageSize, search)
...
import type { EndpointsGoogleChromeConnectorsListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // string | A search term. (optional)
    search: search_example,
  } satisfies EndpointsGoogleChromeConnectorsListRequest;

  try {
    const data = await api.endpointsGoogleChromeConnectorsList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> GoogleChromeConnector endpointsGoogleChromeConnectorsPartialUpdate(connectorUuid, patchedGoogleChromeConnectorRequest)
...
import type { EndpointsGoogleChromeConnectorsPartialUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Google Device Trust Connector.
    connectorUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // PatchedGoogleChromeConnectorRequest (optional)
    patchedGoogleChromeConnectorRequest: ...,
  } satisfies EndpointsGoogleChromeConnectorsPartialUpdateRequest;

  try {
    const data = await api.endpointsGoogleChromeConnectorsPartialUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **connectorUuid** | `string` | A UUID string identifying this Google Device Trust Connector. | [Defaults to `undefined`] |
| **patchedGoogleChromeConnectorRequest** | [PatchedGoogleChromeConnectorRequest](PatchedGoogleChromeConnectorRequest.md) |  | [Optional] |
...
> GoogleChromeConnector endpointsGoogleChromeConnectorsRetrieve(connectorUuid)
...
import type { EndpointsGoogleChromeConnectorsRetrieveRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Google Device Trust Connector.
    connectorUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies EndpointsGoogleChromeConnectorsRetrieveRequest;

  try {
    const data = await api.endpointsGoogleChromeConnectorsRetrieve(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> GoogleChromeConnector endpointsGoogleChromeConnectorsUpdate(connectorUuid, googleChromeConnectorRequest)
...
import type { EndpointsGoogleChromeConnectorsUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // GoogleChromeConnectorRequest
    googleChromeConnectorRequest: ...,
  } satisfies EndpointsGoogleChromeConnectorsUpdateRequest;

  try {
    const data = await api.endpointsGoogleChromeConnectorsUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> Array&lt;UsedBy&gt; endpointsGoogleChromeConnectorsUsedByList(connectorUuid)
...
import type { EndpointsGoogleChromeConnectorsUsedByListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Google Device Trust Connector.
    connectorUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies EndpointsGoogleChromeConnectorsUsedByListRequest;

  try {
    const data = await api.endpointsGoogleChromeConnectorsUsedByList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
