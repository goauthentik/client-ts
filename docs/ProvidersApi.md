...
> OAuth2DynamicClientRegistration providersOauth2DcrCreate(oAuth2DynamicClientRegistrationRequest)
...
import type { ProvidersOauth2DcrCreateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    oAuth2DynamicClientRegistrationRequest: ...,
  } satisfies ProvidersOauth2DcrCreateRequest;

  try {
    const data = await api.providersOauth2DcrCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> providersOauth2DcrDestroy(pbmUuid)
...
import type { ProvidersOauth2DcrDestroyRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this OAuth2 Dynamic Client Registration.
    pbmUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies ProvidersOauth2DcrDestroyRequest;

  try {
    const data = await api.providersOauth2DcrDestroy(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **pbmUuid** | `string` | A UUID string identifying this OAuth2 Dynamic Client Registration. | [Defaults to `undefined`] |
...
> PaginatedOAuth2DynamicClientRegistrationList providersOauth2DcrList(ordering, page, pageSize, provider, search)
...
import type { ProvidersOauth2DcrListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // string | A search term. (optional)
    search: search_example,
  } satisfies ProvidersOauth2DcrListRequest;

  try {
    const data = await api.providersOauth2DcrList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OAuth2DynamicClientRegistration providersOauth2DcrPartialUpdate(pbmUuid, patchedOAuth2DynamicClientRegistrationRequest)
...
import type { ProvidersOauth2DcrPartialUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this OAuth2 Dynamic Client Registration.
    pbmUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // PatchedOAuth2DynamicClientRegistrationRequest (optional)
    patchedOAuth2DynamicClientRegistrationRequest: ...,
  } satisfies ProvidersOauth2DcrPartialUpdateRequest;

  try {
    const data = await api.providersOauth2DcrPartialUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **pbmUuid** | `string` | A UUID string identifying this OAuth2 Dynamic Client Registration. | [Defaults to `undefined`] |
| **patchedOAuth2DynamicClientRegistrationRequest** | [PatchedOAuth2DynamicClientRegistrationRequest](PatchedOAuth2DynamicClientRegistrationRequest.md) |  | [Optional] |
...
> OAuth2DynamicClientRegistration providersOauth2DcrRetrieve(pbmUuid)
...
import type { ProvidersOauth2DcrRetrieveRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this OAuth2 Dynamic Client Registration.
    pbmUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies ProvidersOauth2DcrRetrieveRequest;

  try {
    const data = await api.providersOauth2DcrRetrieve(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OAuth2DynamicClientRegistration providersOauth2DcrUpdate(pbmUuid, oAuth2DynamicClientRegistrationRequest)
...
import type { ProvidersOauth2DcrUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // OAuth2DynamicClientRegistrationRequest
    oAuth2DynamicClientRegistrationRequest: ...,
  } satisfies ProvidersOauth2DcrUpdateRequest;

  try {
    const data = await api.providersOauth2DcrUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
async function example() {
  ...
  const body = {
    ...
    // ClientTypeEnum (optional)
    clientType: ...,
    // boolean (optional)
    includeClaimsInIdToken: true,
    // IssuerModeEnum (optional)
    issuerMode: ...,
    // string (optional)
    name: name_example,
    // string | Which field to use when ordering the results. (optional)
...
| **clientType** | `ClientTypeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: confidential, public] |
| **includeClaimsInIdToken** | `boolean` |  | [Optional] [Defaults to `undefined`] |
| **issuerMode** | `IssuerModeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: global, per_provider] |
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
...
| **subMode** | `SubModeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: hashed_user_id, user_id, user_uuid, user_username, user_email, user_upn] |
...
> PaginatedSAMLProviderList providersSamlList(acsUrl, assertionValidNotBefore, assertionValidNotOnOrAfter, audience, authenticationFlow, authnContextClassRefMapping, authorizationFlow, backchannelApplication, defaultNameIdPolicy, defaultRelayState, digestAlgorithm, encryptionKp, invalidationFlow, isBackchannel, issuerOverride, logoutMethod, name, nameIdMapping, ordering, page, pageSize, propertyMappings, search, sessionValidNotOnOrAfter, signAssertion, signLogoutRequest, signLogoutResponse, signResponse, signatureAlgorithm, signingKp, slsBinding, slsUrl, spBinding, verificationKp)
...
async function example() {
  ...
  const body = {
    ...
    isBackchannel: true,
    // string (optional)
    issuerOverride: issuerOverride_example,
    // SAMLLogoutMethods (optional)
    logoutMethod: ...,
    // string (optional)
    name: name_example,
    // string (optional)
...
| **defaultNameIdPolicy** | `SAMLNameIDPolicyEnum` |  | [Optional] [Defaults to `undefined`] [Enum: urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress, urn:oasis:names:tc:SAML:2.0:nameid-format:persistent, urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName, urn:oasis:names:tc:SAML:2.0:nameid-format:WindowsDomainQualifiedName, urn:oasis:names:tc:SAML:2.0:nameid-format:transient, urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified] |
...
| **issuerOverride** | `string` |  | [Optional] [Defaults to `undefined`] |
| **logoutMethod** | `SAMLLogoutMethods` |  | [Optional] [Defaults to `undefined`] [Enum: frontchannel_iframe, frontchannel_native, backchannel] |
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
...
| **signLogoutResponse** | `boolean` |  | [Optional] [Defaults to `undefined`] |
...
| **slsBinding** | `SAMLBindingsEnum` |  | [Optional] [Defaults to `undefined`] [Enum: redirect, post] |
| **slsUrl** | `string` |  | [Optional] [Defaults to `undefined`] |
| **spBinding** | `SAMLBindingsEnum` |  | [Optional] [Defaults to `undefined`] [Enum: redirect, post] |
...
| **forceBinding** | `ForceBindingEnum` |  | [Optional] [Defaults to `undefined`] [Enum: urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST, urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect] |
...
> PaginatedSCIMProviderList providersScimList(excludeUsersServiceAccount, groupFilters, name, ordering, page, pageSize, search, url)
...
|------------- | ------------- | ------------- | -------------|
| **excludeUsersServiceAccount** | `boolean` |  | [Optional] [Defaults to `undefined`] |
| **groupFilters** | `Array<string>` |  | [Optional] |
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
...
> WSFederationProvider providersWsfedCreate(wSFederationProviderRequest)
...
import type { ProvidersWsfedCreateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    wSFederationProviderRequest: ...,
  } satisfies ProvidersWsfedCreateRequest;

  try {
    const data = await api.providersWsfedCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { ProvidersWsfedDestroyRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // number | A unique integer value identifying this WS-Federation Provider.
    id: 56,
  } satisfies ProvidersWsfedDestroyRequest;

  try {
    const data = await api.providersWsfedDestroy(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **id** | `number` | A unique integer value identifying this WS-Federation Provider. | [Defaults to `undefined`] |
...
> PaginatedWSFederationProviderList providersWsfedList(acsUrl, assertionValidNotBefore, assertionValidNotOnOrAfter, audience, authenticationFlow, authnContextClassRefMapping, authorizationFlow, backchannelApplication, defaultNameIdPolicy, defaultRelayState, digestAlgorithm, encryptionKp, invalidationFlow, isBackchannel, issuerOverride, logoutMethod, name, nameIdMapping, ordering, page, pageSize, propertyMappings, samlVersion, search, sessionValidNotOnOrAfter, signAssertion, signLogoutRequest, signLogoutResponse, signResponse, signatureAlgorithm, signingKp, slsBinding, slsUrl, spBinding, verificationKp)
...
import type { ProvidersWsfedListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // string (optional)
    verificationKp: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies ProvidersWsfedListRequest;

  try {
    const data = await api.providersWsfedList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
| **propertyMappings** | `Array<string>` |  | [Optional] |
| **samlVersion** | `SamlVersionEnum` |  | [Optional] [Defaults to `undefined`] [Enum: 1.1, 2.0] |
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
| **sessionValidNotOnOrAfter** | `string` |  | [Optional] [Defaults to `undefined`] |
| **signAssertion** | `boolean` |  | [Optional] [Defaults to `undefined`] |
| **signLogoutRequest** | `boolean` |  | [Optional] [Defaults to `undefined`] |
...
> SAMLMetadata providersWsfedMetadataRetrieve(id, download, forceBinding)
...
import type { ProvidersWsfedMetadataRetrieveRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // ForceBindingEnum (optional)
    forceBinding: ...,
  } satisfies ProvidersWsfedMetadataRetrieveRequest;

  try {
    const data = await api.providersWsfedMetadataRetrieve(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> WSFederationProvider providersWsfedPartialUpdate(id, patchedWSFederationProviderRequest)
...
import type { ProvidersWsfedPartialUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // number | A unique integer value identifying this WS-Federation Provider.
    id: 56,
    // PatchedWSFederationProviderRequest (optional)
    patchedWSFederationProviderRequest: ...,
  } satisfies ProvidersWsfedPartialUpdateRequest;

  try {
    const data = await api.providersWsfedPartialUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> PropertyMappingPreview providersWsfedPreviewUserRetrieve(id, forUser)
...
import type { ProvidersWsfedPreviewUserRetrieveRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // number (optional)
    forUser: 56,
  } satisfies ProvidersWsfedPreviewUserRetrieveRequest;

  try {
    const data = await api.providersWsfedPreviewUserRetrieve(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> WSFederationProvider providersWsfedRetrieve(id)
...
import type { ProvidersWsfedRetrieveRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // number | A unique integer value identifying this WS-Federation Provider.
    id: 56,
  } satisfies ProvidersWsfedRetrieveRequest;

  try {
    const data = await api.providersWsfedRetrieve(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> WSFederationProvider providersWsfedUpdate(id, wSFederationProviderRequest)
...
import type { ProvidersWsfedUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // WSFederationProviderRequest
    wSFederationProviderRequest: ...,
  } satisfies ProvidersWsfedUpdateRequest;

  try {
    const data = await api.providersWsfedUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> Array&lt;UsedBy&gt; providersWsfedUsedByList(id)
...
import type { ProvidersWsfedUsedByListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // number | A unique integer value identifying this WS-Federation Provider.
    id: 56,
  } satisfies ProvidersWsfedUsedByListRequest;

  try {
    const data = await api.providersWsfedUsedByList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
