...
export function RequestableTargetToJSONTyped(value?: Omit<RequestableTarget, 'verbose_name'|'verbose_name_plural'|'meta_model_name'|'pbm_uuid'|'label'|'parent'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
