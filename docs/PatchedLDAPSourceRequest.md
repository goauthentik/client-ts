...
```typescript
import type { PatchedLDAPSourceRequest } from '@goauthentik/api'
...
const example = {
  ...
  "syncGroupHierarchy": null,
} satisfies PatchedLDAPSourceRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedLDAPSourceRequest
