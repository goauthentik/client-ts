...
> AccountLockdownStage stagesAccountLockdownCreate(accountLockdownStageRequest)
...
import type { StagesAccountLockdownCreateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    accountLockdownStageRequest: ...,
  } satisfies StagesAccountLockdownCreateRequest;

  try {
    const data = await api.stagesAccountLockdownCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> stagesAccountLockdownDestroy(stageUuid)
...
import type { StagesAccountLockdownDestroyRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Account Lockdown Stage.
    stageUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies StagesAccountLockdownDestroyRequest;

  try {
    const data = await api.stagesAccountLockdownDestroy(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **stageUuid** | `string` | A UUID string identifying this Account Lockdown Stage. | [Defaults to `undefined`] |
...
> PaginatedAccountLockdownStageList stagesAccountLockdownList(deactivateUser, deleteSessions, name, ordering, page, pageSize, revokeTokens, search, selfServiceCompletionFlow, setUnusablePassword, stageUuid)
...
import type { StagesAccountLockdownListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // string (optional)
    selfServiceCompletionFlow: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // boolean (optional)
    setUnusablePassword: true,
    // string (optional)
    stageUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies StagesAccountLockdownListRequest;

  try {
    const data = await api.stagesAccountLockdownList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **deactivateUser** | `boolean` |  | [Optional] [Defaults to `undefined`] |
| **deleteSessions** | `boolean` |  | [Optional] [Defaults to `undefined`] |
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
| **revokeTokens** | `boolean` |  | [Optional] [Defaults to `undefined`] |
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
| **selfServiceCompletionFlow** | `string` |  | [Optional] [Defaults to `undefined`] |
| **setUnusablePassword** | `boolean` |  | [Optional] [Defaults to `undefined`] |
...
> AccountLockdownStage stagesAccountLockdownPartialUpdate(stageUuid, patchedAccountLockdownStageRequest)
...
import type { StagesAccountLockdownPartialUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Account Lockdown Stage.
    stageUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // PatchedAccountLockdownStageRequest (optional)
    patchedAccountLockdownStageRequest: ...,
  } satisfies StagesAccountLockdownPartialUpdateRequest;

  try {
    const data = await api.stagesAccountLockdownPartialUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **stageUuid** | `string` | A UUID string identifying this Account Lockdown Stage. | [Defaults to `undefined`] |
| **patchedAccountLockdownStageRequest** | [PatchedAccountLockdownStageRequest](PatchedAccountLockdownStageRequest.md) |  | [Optional] |
...
> AccountLockdownStage stagesAccountLockdownRetrieve(stageUuid)
...
import type { StagesAccountLockdownRetrieveRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Account Lockdown Stage.
    stageUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies StagesAccountLockdownRetrieveRequest;

  try {
    const data = await api.stagesAccountLockdownRetrieve(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> AccountLockdownStage stagesAccountLockdownUpdate(stageUuid, accountLockdownStageRequest)
...
import type { StagesAccountLockdownUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // AccountLockdownStageRequest
    accountLockdownStageRequest: ...,
  } satisfies StagesAccountLockdownUpdateRequest;

  try {
    const data = await api.stagesAccountLockdownUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> Array&lt;UsedBy&gt; stagesAccountLockdownUsedByList(stageUuid)
...
import type { StagesAccountLockdownUsedByListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Account Lockdown Stage.
    stageUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies StagesAccountLockdownUsedByListRequest;

  try {
    const data = await api.stagesAccountLockdownUsedByList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **authType** | `AuthTypeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: basic, bearer] |
| **configureFlow** | `string` |  | [Optional] [Defaults to `undefined`] |
| **friendlyName** | `string` |  | [Optional] [Defaults to `undefined`] |
...
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
| **provider** | `ProviderEnum` |  | [Optional] [Defaults to `undefined`] [Enum: twilio, generic] |
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
| **stageUuid** | `string` |  | [Optional] [Defaults to `undefined`] |
...
|------------- | ------------- | ------------- | -------------|
| **configureFlow** | `string` |  | [Optional] [Defaults to `undefined`] |
| **digits** | `DigitsEnum` |  | [Optional] [Defaults to `undefined`] [Enum: 6, 8] |
| **friendlyName** | `string` |  | [Optional] [Defaults to `undefined`] |
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
...
async function example() {
  ...
  const body = {
    ...
    // string (optional)
    name: name_example,
    // NotConfiguredActionEnum (optional)
    notConfiguredAction: ...,
    // string | Which field to use when ordering the results. (optional)
    ordering: ordering_example,
    // number | A page number within the paginated result set. (optional)
...
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
| **notConfiguredAction** | `NotConfiguredActionEnum` |  | [Optional] [Defaults to `undefined`] [Enum: skip, deny, configure] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
...
> PaginatedAuthenticatorWebAuthnStageList stagesAuthenticatorWebauthnList(authenticatorAttachment, configureFlow, deviceTypeRestrictions, maxAttempts, name, ordering, page, pageSize, residentKeyRequirement, search, userVerification)
...
async function example() {
  ...
  const body = {
    // AuthenticatorAttachmentEnum (optional)
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **authenticatorAttachment** | `AuthenticatorAttachmentEnum` |  | [Optional] [Defaults to `undefined`] [Enum: platform, cross-platform] |
| **configureFlow** | `string` |  | [Optional] [Defaults to `undefined`] |
...
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
| **residentKeyRequirement** | `UserVerificationEnum` |  | [Optional] [Defaults to `undefined`] [Enum: required, preferred, discouraged] |
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
| **userVerification** | `UserVerificationEnum` |  | [Optional] [Defaults to `undefined`] [Enum: required, preferred, discouraged] |
...
| **mode** | `ConsentModeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: always_require, permanent, expiring] |
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
...
> stagesInvitationInvitationsSendEmailCreate(inviteUuid, invitationSendEmailRequest)
...
import type { StagesInvitationInvitationsSendEmailCreateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    invitationSendEmailRequest: ...,
  } satisfies StagesInvitationInvitationsSendEmailCreateRequest;

  try {
    const data = await api.stagesInvitationInvitationsSendEmailCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
async function example() {
  ...
  const body = {
    // CertAttributeEnum (optional)
    certAttribute: ...,
    // Array<string> (optional)
    certificateAuthorities: ...,
    // StageModeEnum (optional)
    mode: ...,
    // string (optional)
    name: name_example,
    // string | Which field to use when ordering the results. (optional)
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **certAttribute** | `CertAttributeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: subject, common_name, email] |
| **certificateAuthorities** | `Array<string>` |  | [Optional] |
| **mode** | `StageModeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: optional, required] |
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
| **stageUuid** | `string` |  | [Optional] [Defaults to `undefined`] |
| **userAttribute** | `UserAttributeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: username, email] |
...
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
| **type** | `PromptTypeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: text, text_area, text_read_only, text_area_read_only, username, email, password, number, checkbox, radio-button-group, dropdown, date, date-time, file, separator, hidden, static, alert_info, alert_warning, alert_danger, ak-locale] |
...
async function example() {
  ...
  const body = {
    // GeoipBindingEnum (optional)
    geoipBinding: ...,
    // string (optional)
    name: name_example,
    // NetworkBindingEnum (optional)
    networkBinding: ...,
    // string | Which field to use when ordering the results. (optional)
    ordering: ordering_example,
    // number | A page number within the paginated result set. (optional)
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **geoipBinding** | `GeoipBindingEnum` |  | [Optional] [Defaults to `undefined`] [Enum: no_binding, bind_continent, bind_continent_country, bind_continent_country_city] |
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
| **networkBinding** | `NetworkBindingEnum` |  | [Optional] [Defaults to `undefined`] [Enum: no_binding, bind_asn, bind_asn_network, bind_asn_network_ip] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
...
async function example() {
  ...
  const body = {
    ...
    // string (optional)
    stageUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // UserCreationModeEnum (optional)
    userCreationMode: ...,
    // string (optional)
    userPathTemplate: userPathTemplate_example,
    // UserTypeEnum (optional)
    userType: ...,
...
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
| **stageUuid** | `string` |  | [Optional] [Defaults to `undefined`] |
| **userCreationMode** | `UserCreationModeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: never_create, create_when_required, always_create] |
| **userPathTemplate** | `string` |  | [Optional] [Defaults to `undefined`] |
| **userType** | `UserTypeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: internal, external, service_account, internal_service_account] |
