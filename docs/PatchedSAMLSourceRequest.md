...
```typescript
import type { PatchedSAMLSourceRequest } from '@goauthentik/api'
...
const example = {
  ...
  "signedResponse": null,
} satisfies PatchedSAMLSourceRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedSAMLSourceRequest
