...
```typescript
import type { PatchedAuthenticatorWebAuthnStageRequest } from '@goauthentik/api'
...
const example = {
  ...
  "maxAttempts": null,
} satisfies PatchedAuthenticatorWebAuthnStageRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedAuthenticatorWebAuthnStageRequest
