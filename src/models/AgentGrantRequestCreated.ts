...
export function instanceOfAgentGrantRequestCreated(value: object): value is AgentGrantRequestCreated {
    if (!('grantRequest' in value) || value['grantRequest'] === undefined) return false;
    if (!('fulfillUrl' in value) || value['fulfillUrl'] === undefined) return false;
    return true;
}
...
export function AgentGrantRequestCreatedToJSONTyped(value?: Omit<AgentGrantRequestCreated, 'grant_request'|'fulfill_url'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
