...
export function UserSelfToJSONTyped(value?: Omit<UserSelf, 'pk'|'is_active'|'is_superuser'|'is_current'|'groups'|'roles'|'avatar'|'uid'|'settings'|'system_permissions'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
