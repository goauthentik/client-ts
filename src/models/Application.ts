...
export function ApplicationToJSONTyped(value?: Omit<Application, 'pk'|'pbm_uuid'|'provider_obj'|'backchannel_providers_obj'|'launch_url'|'meta_icon_url'|'meta_icon_themed_urls'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
