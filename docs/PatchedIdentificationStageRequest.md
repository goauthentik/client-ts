...
```typescript
import type { PatchedIdentificationStageRequest } from '@goauthentik/api'
...
const example = {
  ...
  "webauthnStage": null,
} satisfies PatchedIdentificationStageRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedIdentificationStageRequest
