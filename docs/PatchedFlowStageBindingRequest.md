...
```typescript
import type { PatchedFlowStageBindingRequest } from '@goauthentik/api'
...
} satisfies PatchedFlowStageBindingRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedFlowStageBindingRequest
