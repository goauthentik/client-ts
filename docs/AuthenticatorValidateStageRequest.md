...
```typescript
import type { AuthenticatorValidateStageRequest } from '@goauthentik/api'
...
} satisfies AuthenticatorValidateStageRequest
...
const exampleParsed = JSON.parse(exampleJSON) as AuthenticatorValidateStageRequest
