...
```typescript
import type { UserLoginStageRequest } from '@goauthentik/api'
...
const example = {
  ...
  "geoipBinding": null,
  "rememberDevice": null,
} satisfies UserLoginStageRequest
...
const exampleParsed = JSON.parse(exampleJSON) as UserLoginStageRequest
