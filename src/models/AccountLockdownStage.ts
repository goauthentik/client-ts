...
export function AccountLockdownStageFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountLockdownStage {
    ...
    return {
        ...
        'selfServiceCompletionFlow': json['self_service_completion_flow'] == null ? undefined : json['self_service_completion_flow'],
    };
}
...
export function AccountLockdownStageToJSONTyped(value?: Omit<AccountLockdownStage, 'pk'|'component'|'verbose_name'|'verbose_name_plural'|'meta_model_name'|'flow_set'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
