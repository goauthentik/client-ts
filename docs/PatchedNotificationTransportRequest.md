...
```typescript
import type { PatchedNotificationTransportRequest } from '@goauthentik/api'
...
const example = {
  ...
  "emailTemplate": null,
  "sendOnce": null,
} satisfies PatchedNotificationTransportRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedNotificationTransportRequest
