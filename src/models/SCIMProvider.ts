...
export function instanceOfSCIMProvider(value: object): value is SCIMProvider {
    ...
    if (!('authOauthTokenLastUpdated' in value) || value['authOauthTokenLastUpdated'] === undefined) return false;
    if (!('authOauthTokenExpires' in value) || value['authOauthTokenExpires'] === undefined) return false;
    if (!('authOauthUrlCallback' in value) || value['authOauthUrlCallback'] === undefined) return false;
...
export function SCIMProviderFromJSONTyped(json: any, ignoreDiscriminator: boolean): SCIMProvider {
    ...
    return {
        ...
        'authOauthTokenLastUpdated': (json['auth_oauth_token_last_updated'] == null ? null : new Date(json['auth_oauth_token_last_updated'])),
        'authOauthTokenExpires': (json['auth_oauth_token_expires'] == null ? null : new Date(json['auth_oauth_token_expires'])),
