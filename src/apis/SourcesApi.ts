...
export class SourcesApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for sourcesAllSetIconCreate without sending the request
     */
    async sourcesAllSetIconCreateRequestOpts(requestParameters: SourcesAllSetIconCreateRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['slug'] == null) {
            throw new runtime.RequiredError(
                'slug',
    ...
    async sourcesAllSetIconCreateRaw(requestParameters: SourcesAllSetIconCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.sourcesAllSetIconCreateRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
    ...
    /**
     * Creates request options for sourcesAllSetIconUrlCreate without sending the request
     */
    async sourcesAllSetIconUrlCreateRequestOpts(requestParameters: SourcesAllSetIconUrlCreateRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['slug'] == null) {
            throw new runtime.RequiredError(
                'slug',
    ...
    async sourcesAllSetIconUrlCreateRaw(requestParameters: SourcesAllSetIconUrlCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.sourcesAllSetIconUrlCreateRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
