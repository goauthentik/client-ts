...
`spBinding` | [SpBindingEnum](SpBindingEnum.md)
...
```typescript
import type { SAMLProviderRequest } from '@goauthentik/api'
...
const exampleParsed = JSON.parse(exampleJSON) as SAMLProviderRequest
