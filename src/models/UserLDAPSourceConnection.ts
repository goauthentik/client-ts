...
export function UserLDAPSourceConnectionToJSONTyped(value?: Omit<UserLDAPSourceConnection, 'pk'|'user'|'source_obj'|'created'|'last_updated'|'user_obj'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
