...
async function example() {
  ...
  const body = {
    ...
    // string (optional)
    fsbUuid: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // InvalidResponseActionEnum (optional)
...
| **invalidResponseAction** | `InvalidResponseActionEnum` |  | [Optional] [Defaults to `undefined`] [Enum: retry, restart, restart_with_context] |
...
async function example() {
  ...
  const body = {
    // DeniedActionEnum (optional)
    deniedAction: ...,
    // FlowDesignationEnum (optional)
    designation: ...,
    // string (optional)
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **deniedAction** | `DeniedActionEnum` |  | [Optional] [Defaults to `undefined`] [Enum: message_continue, message, continue] |
| **designation** | `FlowDesignationEnum` |  | [Optional] [Defaults to `undefined`] [Enum: authentication, authorization, invalidation, enrollment, unenrollment, recovery, stage_configuration] |
