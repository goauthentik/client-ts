...
export function instanceOfAgent(value: object): value is Agent {
    ...
    if (!('policyBehavior' in value) || value['policyBehavior'] === undefined) return false;
...
export function AgentToJSONTyped(value?: Omit<Agent, 'pk'|'uid'|'uuid'|'parent'|'policy_behavior'|'token_identifier'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
