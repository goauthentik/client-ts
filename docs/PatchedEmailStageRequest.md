...
```typescript
import type { PatchedEmailStageRequest } from '@goauthentik/api'
...
} satisfies PatchedEmailStageRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PatchedEmailStageRequest
