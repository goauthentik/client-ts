...
> DataExport eventsEventsExportCreate(action, actions, brandName, clientIp, contextAuthorizedApp, contextDevice, contextModelApp, contextModelName, contextModelPk, ordering, search, username)
...
async function example() {
  ...
  const body = {
    ...
    // string | Context Device Primary Key (optional)
    contextDevice: contextDevice_example,
...
| **actions** | `Array<EventActions>` |  | [Optional] |
...
| **contextDevice** | `string` | Context Device Primary Key | [Optional] [Defaults to `undefined`] |
...
> PaginatedEventList eventsEventsList(action, actions, brandName, clientIp, contextAuthorizedApp, contextDevice, contextModelApp, contextModelName, contextModelPk, ordering, page, pageSize, search, username)
...
> EventStats eventsEventsStatsRetrieve(countSteps, action, actions, brandName, clientIp, contextAuthorizedApp, contextDevice, contextModelApp, contextModelName, contextModelPk, ordering, search, username)
...
import type { EventsEventsStatsRetrieveRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // Array<string> | Timedelta, format of \'weeks=3;days=2;hours=3,seconds=2\'
    countSteps: ...,
    // string (optional)
    action: action_example,
    // Array<EventActions> (optional)
    ...
    // string | Username (optional)
    username: username_example,
  } satisfies EventsEventsStatsRetrieveRequest;

  try {
    const data = await api.eventsEventsStatsRetrieve(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **countSteps** | `Array<string>` | Timedelta, format of \&#39;weeks&#x3D;3;days&#x3D;2;hours&#x3D;3,seconds&#x3D;2\&#39; | |
| **action** | `string` |  | [Optional] [Defaults to `undefined`] |
| **actions** | `Array<EventActions>` |  | [Optional] |
| **brandName** | `string` | Brand name | [Optional] [Defaults to `undefined`] |
| **clientIp** | `string` |  | [Optional] [Defaults to `undefined`] |
...
> Array&lt;EventTopPerUser&gt; eventsEventsTopPerUserList(action, actions, brandName, clientIp, contextAuthorizedApp, contextDevice, contextModelApp, contextModelName, contextModelPk, ordering, search, topN, username)
...
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
| **topN** | `number` |  | [Optional] [Defaults to `15`] |
| **username** | `string` | Username | [Optional] [Defaults to `undefined`] |
...
> Array&lt;EventVolume&gt; eventsEventsVolumeList(action, actions, brandName, clientIp, contextAuthorizedApp, contextDevice, contextModelApp, contextModelName, contextModelPk, historyDays, ordering, search, username)
...
| **severity** | `SeverityEnum` |  | [Optional] [Defaults to `undefined`] [Enum: notice, warning, alert] |
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **mode** | `TransportModeEnum` |  | [Optional] [Defaults to `undefined`] [Enum: local, webhook, webhook_slack, email] |
| **name** | `string` |  | [Optional] [Defaults to `undefined`] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
