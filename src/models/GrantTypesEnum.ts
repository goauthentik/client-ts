...
export function GrantTypesEnumFromJSONTyped(json: any, ignoreDiscriminator: boolean): GrantTypesEnum {
...
export function GrantTypesEnumToJSONTyped(value: any, ignoreDiscriminator: boolean): GrantTypesEnum {
