...
> PaginatedRequestableTargetList coreApplicationEntitlementsRequestableList(app, name, ordering, page, pageSize, pbmUuid, search)
...
import type { CoreApplicationEntitlementsRequestableListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // string | A search term. (optional)
    search: search_example,
  } satisfies CoreApplicationEntitlementsRequestableListRequest;

  try {
    const data = await api.coreApplicationEntitlementsRequestableList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> PaginatedApplicationList coreApplicationsRequestableList(group, metaDescription, metaLaunchUrl, metaPublisher, name, ordering, page, pageSize, search, slug)
...
import type { CoreApplicationsRequestableListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // string (optional)
    slug: slug_example,
  } satisfies CoreApplicationsRequestableListRequest;

  try {
    const data = await api.coreApplicationsRequestableList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> ObjectAttribute coreObjectAttributesCreate(objectAttributeRequest)
...
import type { CoreObjectAttributesCreateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    objectAttributeRequest: ...,
  } satisfies CoreObjectAttributesCreateRequest;

  try {
    const data = await api.coreObjectAttributesCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> coreObjectAttributesDestroy(attributeId)
...
import type { CoreObjectAttributesDestroyRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Object Attribute.
    attributeId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies CoreObjectAttributesDestroyRequest;

  try {
    const data = await api.coreObjectAttributesDestroy(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **attributeId** | `string` | A UUID string identifying this Object Attribute. | [Defaults to `undefined`] |
...
> PaginatedObjectAttributeList coreObjectAttributesList(enabled, objectTypeAppLabel, objectTypeModel, ordering, page, pageSize, search)
...
import type { CoreObjectAttributesListRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    enabled: true,
    // string (optional)
    objectTypeAppLabel: objectTypeAppLabel_example,
    // string (optional)
    objectTypeModel: objectTypeModel_example,
    // string | Which field to use when ordering the results. (optional)
    ordering: ordering_example,
    // number | A page number within the paginated result set. (optional)
    page: 56,
    ...
    // string | A search term. (optional)
    search: search_example,
  } satisfies CoreObjectAttributesListRequest;

  try {
    const data = await api.coreObjectAttributesList(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **objectTypeAppLabel** | `string` |  | [Optional] [Defaults to `undefined`] |
| **objectTypeModel** | `string` |  | [Optional] [Defaults to `undefined`] |
| **ordering** | `string` | Which field to use when ordering the results. | [Optional] [Defaults to `undefined`] |
| **page** | `number` | A page number within the paginated result set. | [Optional] [Defaults to `undefined`] |
| **pageSize** | `number` | Number of results to return per page. | [Optional] [Defaults to `undefined`] |
| **search** | `string` | A search term. | [Optional] [Defaults to `undefined`] |
...
> ObjectAttribute coreObjectAttributesPartialUpdate(attributeId, patchedObjectAttributeRequest)
...
import type { CoreObjectAttributesPartialUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Object Attribute.
    attributeId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
    // PatchedObjectAttributeRequest (optional)
    patchedObjectAttributeRequest: ...,
  } satisfies CoreObjectAttributesPartialUpdateRequest;

  try {
    const data = await api.coreObjectAttributesPartialUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **attributeId** | `string` | A UUID string identifying this Object Attribute. | [Defaults to `undefined`] |
| **patchedObjectAttributeRequest** | [PatchedObjectAttributeRequest](PatchedObjectAttributeRequest.md) |  | [Optional] |
...
> ObjectAttribute coreObjectAttributesRetrieve(attributeId)
...
import type { CoreObjectAttributesRetrieveRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string | A UUID string identifying this Object Attribute.
    attributeId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies CoreObjectAttributesRetrieveRequest;

  try {
    const data = await api.coreObjectAttributesRetrieve(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> ObjectAttribute coreObjectAttributesUpdate(attributeId, objectAttributeRequest)
...
import type { CoreObjectAttributesUpdateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    ...
    // ObjectAttributeRequest
    objectAttributeRequest: ...,
  } satisfies CoreObjectAttributesUpdateRequest;

  try {
    const data = await api.coreObjectAttributesUpdate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> UserSwitchResponse coreUsersSwitchCreate(next, userSwitchRequest)
...
import type { CoreUsersSwitchCreateRequest } from '@goauthentik/api';
...
async function example() {
  ...
  const body = {
    // string (optional)
    next: next_example,
    // UserSwitchRequest (optional)
    userSwitchRequest: ...,
  } satisfies CoreUsersSwitchCreateRequest;

  try {
    const data = await api.coreUsersSwitchCreate(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **userSwitchRequest** | [UserSwitchRequest](UserSwitchRequest.md) |  | [Optional] |
